...
return [
    ...
    */
    ...
    'unique' => 'El correo electronico ya esta registrado.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de idioma para validaciones personalizadas
    |--------------------------------------------------------------------------
    |
    ...
    | las líneas. Esto ayuda a hacer que los mensajes sean más específicos.
    |
    */
    ...
    | marcador de posición de atributos por algo más amigable para el
    | lector, como "Dirección de correo electrónico" en lugar de "email".
    |
    */

                        ...
                        <nav id="sidebar" class="col-md-3 col-lg-2 sidebar position-fixed h-100 transition-sidebar bg-dark text-light">
                            ...
                            <div class="position-sticky">
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <h4 id="sidebarTitle" class="transition-title">Conciertos Live</h4>
                                </div>
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-light d-flex align-items-center nav-hover" href="/">
                                            <i class="fas fa-tachometer-alt icon-3d"></i>
                                            <span class="sidebar-text ms-2">Página de inicio</span>
                                        </a>
                                    </li>
            {{--
    ...
    {{--
                                    @if (in_array($userRole, [1, 2]))
                                        <li class="nav-item">
                                            <a class="nav-link text-light d-flex align-items-center nav-hover" href="#">
                                                ...
                                                <span class="sidebar-text ms-2">Conciertos</span>
                                            </a>
                                        </li>
                                    @endif
                    {{--
        ...
        --}}
                                    @if (in_array($userRole, [1, 2, 3]))
                                        <li class="nav-item">
                                            <a class="nav-link text-light d-flex align-items-center nav-hover" href="informacion">
